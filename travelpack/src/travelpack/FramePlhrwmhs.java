...
public class FramePlhrwmhs extends JFrame {
	...
	public FramePlhrwmhs(Packet p, UserOptions uo) {
		...
		priceP.setText("Total price: " + p.getTotalprice() + "$");
		...
		priceH.setText("Hotel price: " + p.getHotel().getPrice() + "$");
		...
		priceF.setText("Flight price: " + p.getFlight().getPrice() + "$");
		...
		stoixeiaPlhromhs.setText("Payment info");
		...
		frmtdtxtfldAfethriaTo.setText("Departure: " + p.getFlight().getDepartureCity());
		...
		proorimos.setText("Destination: " + p.getFlight().getDestinationCity());
		...
		frmtdtxtfldHmeromhnia.setText("Date: " + p.getFlight().getDate());
		...
		frmtdtxtfldWraPthshs.setText("Departure time: " + p.getFlight().getTimeAsString() + ":00");
		...
		frmtdtxtfldTypePthshs.setText("Flight type: " + p.getFlight().getType());
		...
		txtArithmosKartas.setText("Card Number");
		...
		txtHmeromhniaLhkshs.setFont(new Font("Tahoma", Font.PLAIN, 17));
		...
		JButton btnNewButton = new JButton("Complete booking");
		...
		lblStoixeiaPthshs.setText("Flight info");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (CheckPayment.checkPayment(txtArithmosKartas.getText(), txtCvv.getText(), txtOnomaKatoxou.getText(),
						txtHmeromhniaLhkshs.getText())) {
